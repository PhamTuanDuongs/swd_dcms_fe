            ...
            <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div className="mr-auto place-self-center lg:col-span-7">
                    <h1 className="max-w-2xl mb-4 text-4xl font-bold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">
                        Unlease the power of your smile
                    </h1>
                    <p className="max-w-2xl mb-6  text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                        Dental clinic is a professional dental clinic that includes General, Cosmetic, Aesthetic, and Emergency Dentistry
                        for you and your family with a team of professional dentists at friendly prices.
                    </p>
                    <Link
                        to="/signup"
                ...
                <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
                    <img className="inline-block rounded-xl" src="/images/smiling-lady.webp" alt="mockup" loading="lazy" />
                </div>
            </div>
        </section>
    );
